...
async function changeBandoColor() {
  const inputImage = join(__dirname, '..', 'attached_assets', 'bando_options', 'lateral-direita.png');
  const outputImage = join(__dirname, '..', 'attached_assets', 'bando_options', 'lateral-direita.png');
