      ...
      <main className="flex-1">
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <p className="text-muted-foreground mb-8">
            Nosso compromisso é garantir a sua satisfação em cada etapa da
            compra. Por isso, criamos uma política clara e objetiva para trocas
            e devoluções, respeitando o Código de Defesa do Consumidor.
          </p>
          ...
          <div className="space-y-8">
            <section>
              ...
              <p className="text-muted-foreground">
                Você pode solicitar a troca ou devolução do seu pedido em até{" "}
                <strong className="text-foreground">7 dias corridos</strong>{" "}
                após o recebimento do produto. Esse direito é assegurado por lei
                e se aplica a compras realizadas fora do estabelecimento
            ...
            <section>
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-2xl font-semibold">
                  Situações em que Aceitamos Trocas ou Devoluções
                </h2>
              </div>
              <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                ...
                <li>
                  Exercício do direito de arrependimento dentro do prazo legal
                  de 7 dias
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="mb-3">
                Para que a troca ou devolução seja aceita, o item deve ser
                enviado:
              </p>
              <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
              ...
              <ul className="space-y-3 ml-4">
                <li>
                  <strong className="text-foreground">
                    Devoluções por arrependimento (dentro do prazo de 7 dias):
                  </strong>
                  <span className="text-muted-foreground">
                    {" "}
                    os custos de envio são de responsabilidade da Persiana
                    Prática.
                  </span>
                </li>
                <li>
                  ...
                  <span className="text-muted-foreground">
                    {" "}
                    o frete de envio e reenvio será por conta do cliente.
                  </span>
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground mt-4">
                Nossa equipe fornecerá todas as instruções para o envio do
                produto.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground mb-4">
                O valor pago será restituído somente após o recebimento e
                análise técnica do produto devolvido. Essa avaliação é realizada
                em até <strong className="text-foreground">5 dias úteis</strong>{" "}
                após a chegada do item à fábrica.
              </p>
              <div className="p-4 bg-muted/50 rounded-md border">
                <div className="flex gap-2">
                  <AlertCircle className="h-5 w-5 text-[hsl(35,65%,55%)] flex-shrink-0 mt-0.5" />
                  <div className="text-sm text-muted-foreground">
                    <strong className="text-foreground">Atenção:</strong> O
                    simples envio do produto ou entrega à transportadora não
                    garante o reembolso antes da conclusão da análise.
                  </div>
                </div>
              </div>
            </section>
