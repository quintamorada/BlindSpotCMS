...
import { Shield, CheckCircle, AlertCircle, Clock, DollarSign } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <p className="text-muted-foreground mb-8">
          Na {siteTitle}, prezamos pela qualidade dos nossos produtos e pela satisfação dos nossos clientes. 
          Por isso, oferecemos garantia contra defeitos de fabricação, conforme os termos abaixo:
        </p>
        ...
        <div className="space-y-8">
          <section>
            ...
            <p className="text-muted-foreground">
              Todos os produtos possuem garantia de <strong className="text-foreground">12 meses</strong> a partir da data 
              de emissão da nota fiscal. Esse prazo cobre exclusivamente falhas de fabricação e não inclui danos causados 
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-3">A garantia contempla:</p>
            <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
              <li>Defeitos de fabricação em componentes, tecidos ou mecanismos</li>
              <li>Problemas estruturais que comprometam o funcionamento da persiana</li>
          ...
          <section>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-2xl font-semibold">O Que Não Está Incluso</h2>
            </div>
            <p className="text-muted-foreground mb-3">A garantia não cobre:</p>
            <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
              <li>Danos causados por instalação incorreta ou realizada por terceiros</li>
              <li>Mau uso, acidentes ou impactos</li>
              <li>Exposição excessiva ao sol, umidade ou produtos químicos</li>
          ...
          <section>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-2xl font-semibold">Como Solicitar Atendimento</h2>
            </div>
            <p className="text-muted-foreground mb-4">
              Caso identifique algum problema coberto pela garantia, entre em contato com nosso atendimento:
            </p>
            ...
            <p className="text-muted-foreground mt-4">
              Nossa equipe irá orientar sobre o envio do produto para análise técnica. O prazo para avaliação é de 
              até <strong className="text-foreground">5 dias úteis</strong> após o recebimento.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-3">
              Se for constatado defeito de fabricação, o cliente poderá optar por:
            </p>
            <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
            ...
            <div className="mt-4 p-4 bg-muted/50 rounded-md border">
              <div className="flex gap-2">
                ...
                <div className="text-sm text-muted-foreground">
                  <strong className="text-foreground">Importante:</strong> O simples envio do produto ou entrega à transportadora 
                  não garante a troca ou devolução antes da conclusão da análise técnica.
                </div>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
              <li>A garantia é válida apenas mediante apresentação da nota fiscal</li>
              <li>Produtos personalizados seguem as mesmas condições, desde que o defeito não esteja relacionado à customização solicitada</li>
              <li>Em caso de dúvidas, nossa equipe está à disposição para esclarecer qualquer ponto</li>
            </ul>
          </section>
        </div>
      </div>
