...
export async function seedDatabase() {
  try {
    ...
    const blackout = await storage.createCategory({
      ...
      image: "/stock_images/blackout_curtains_be_a141c3c1.jpg"
    });
    ...
    const rolo = await storage.createCategory({
      ...
      image: "/stock_images/roller_blinds_vertic_09ed5e02.jpg"
    });
    ...
    const vertical = await storage.createCategory({
      ...
      image: "/stock_images/roller_blinds_vertic_6e1dd772.jpg"
    });
    ...
    const horizontal = await storage.createCategory({
      ...
      image: "/stock_images/window_blinds_modern_f03f816b.jpg"
    });
    ...
    await storage.createProduct({
      ...
      images: ["/stock_images/blackout_curtains_be_a141c3c1.jpg"],
      specifications: {
    ...
    await storage.createProduct({
      ...
      price: "249.90",
      categoryId: rolo.id,
      images: ["/stock_images/roller_blinds_vertic_09ed5e02.jpg"],
      specifications: {
    ...
    await storage.createProduct({
      ...
      images: ["/stock_images/roller_blinds_vertic_6e1dd772.jpg"],
      specifications: {
    ...
    await storage.createProduct({
      ...
      images: ["/stock_images/window_blinds_modern_f03f816b.jpg"],
      specifications: {
        material: "Alumínio",
    ...
    await storage.createProduct({
      ...
      price: "399.90",
      categoryId: blackout.id,
      images: ["/stock_images/blackout_curtains_be_535dd2de.jpg"],
      specifications: {
    ...
    await storage.createProduct({
      ...
      price: "279.90",
      categoryId: rolo.id,
      images: ["/stock_images/roller_blinds_vertic_2de45dd7.jpg"],
      specifications: {
    ...
    await storage.createProduct({
      ...
      price: "429.90",
      categoryId: vertical.id,
      images: ["/stock_images/window_blinds_modern_01fb7e69.jpg"],
      specifications: {
    ...
    await storage.createProduct({
      ...
      price: "499.90",
      categoryId: horizontal.id,
      images: ["/stock_images/window_blinds_modern_3f492354.jpg"],
      specifications: {
